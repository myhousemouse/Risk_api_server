...
**중요: 질문 대상자는 초보 창업자입니다.**
- 전문 용어나 어려운 경영 용어는 사용하지 마세요
- 초등학생도 이해할 수 있는 쉬운 말로 질문하세요
- 구체적인 예시를 포함하여 질문하세요

다음 사업에 대해 '{method.value}' 분석 기법을 사용하여 리스크를 파악하기 위한 질문 2~3개를 생성해주세요.
...
4. **초보 창업자가 쉽게 이해하고 답변할 수 있도록** 작성해주세요:
   ...
   - 일상적이고 쉬운 단어로 질문하세요
   - 필요하면 구체적인 예시를 질문에 포함하세요
5. 질문은 측정 가능하거나 명확한 사실을 묻도록 작성하세요:
   - 모호한 질문 ❌: "시장 상황은 어떤가요?"
   - 구체적인 질문 ✅: "한 달에 몇 명의 고객이 우리 제품을 살 것 같나요?"

**출력 형식:**
각 질문을 다음 형식으로 작성해주세요:
Q1: [쉽고 구체적인 질문 내용] | [답변 유형: text/number/choice] | [선택지가 있다면: 선택지1,선택지2,선택지3]

**좋은 질문의 예시 (쉬운 말로):**
Q1: 우리 제품/서비스를 주로 누가 사용하나요? (예: 20대 여성, 중소기업 사장님 등) | text |
Q2: 한 달에 예상되는 수입은 얼마인가요? | number |
Q3: 우리 제품을 경쟁 제품보다 더 싸게/비싸게 팔 건가요? 왜 그렇게 정했나요? | text |
Q4: 지금 가장 부족한 것은 무엇인가요? | choice | 사람,돈,기술,홍보방법,판매처

**나쁜 질문의 예시 (전문 용어 사용 금지):**
❌ "고객 획득 비용(CAC)은 얼마인가요?" → ⭕ "고객 한 명을 얻기 위해 광고비는 얼마나 드나요?"
❌ "시장 침투 전략은 무엇인가요?" → ⭕ "어떻게 고객들에게 우리 제품을 알릴 건가요?"
❌ "핵심 경쟁력은 무엇인가요?" → ⭕ "우리 제품이 다른 제품보다 나은 점은 무엇인가요?"
❌ "수익 모델은 무엇인가요?" → ⭕ "어떻게 돈을 벌 계획인가요?"
"""
